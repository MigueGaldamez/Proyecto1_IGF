                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="my-4">
                                    ...
                                    <input v-model="especialista.estado" type="text" class="form-control" placeholder="estado" id="estado">
                                    <span class="text-danger" v-if="errores.password">{{errores.password[0]}}</span>
                                </div>
                                  <div class="my-4">
                    ...
                    <table class="table table-striped table-sm table-hover">
                        ...
                        <tbody>
                            <tr v-for="especia in especialistas.data" :key="especia.id">
                                ...
                                <td>{{especia.usuario.created_at}}</td>
                            
                               
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" :data-bs-target="'#AceptarModal_'+especia.id">
                                       Ver Solicitud
                                    </button>
                                </td>
                                    ...
                                    <div class="modal fade" :id="'AceptarModal_'+especia.id"  tabindex="-1" :aria-labelledby="'AceptarModalLabel_'+especia.id" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" :id="'AceptarModalLabel_'+especia.id">¿Qué desea realizar con esta solicitud?</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                             
                                                <h5><b>Nombre</b></h5>
                                                <h6>{{especia.usuario.name}}</h6>
                                        
                                                <h5><b>Correo</b></h5>
                                                <h6>{{especia.usuario.email}}</h6>

                                                <h5><b>Especialidad</b></h5>
                                                <h6>{{especia.especialidad.nombre}}</h6>

                                                <h5><b>Codigo profesional</b></h5>
                                                <h6>{{especia.reconocimiento}}</h6>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                <button type="button" class="btn btn-success" @click="aceptar(especia.id);" data-bs-dismiss="modal">Aceptar</button>
                                                <button type="button" class="btn btn-danger" @click="rechazar(especia.id);" data-bs-dismiss="modal">Rechazar</button>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods:{
            async listar(){
                ...
                const res = await axios.get('/solicitud/pendientes/',{params:this.pagination,});
            ...
            async rechazar(id){
                const res = await axios.post('/solicitud/rechazar/?idUsuario='+id);
                this.cerrarModal();
                this.listar();
            },
            async guardar(){
            ...
            abrirModal(data={}){
                ...
                if(this.modificar){
                    ...
                    this.especialista.estado=data.estado;
