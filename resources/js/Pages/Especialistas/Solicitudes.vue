                    ...
                    <table class="table table-striped table-sm table-hover">
                        ...
                        <tbody>
                            <tr v-for="especia in especialistas.data" :key="especia.id">
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" :data-bs-target="'#RechazarModal_'+especia.id">
                                        Rechazar Solicitud
                                    </button>
                                </td>
                                    <!-- Modal Editar-->
                                    <div class="modal fade" :id="'editarModal_'+especia.id"  tabindex="-1" :aria-labelledby="'editarModalLabel_'+especia.id" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="my-4">
                                                    <label for="descripcion">Estado de solicitud </label>
                                                    
                                                </div>
                                                <div>
                                                    <input v-model=" especialista.estado" type="string" class="Label" id="estado">
                                    ...
                                    <div class="modal fade" :id="'AceptarModal_'+especia.id"  tabindex="-1" :aria-labelledby="'AceptarModalLabel_'+especia.id" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                <button type="button" class="btn btn-success" @click="aceptar(especia.id);" data-bs-dismiss="modal">Si, Aceptar</button>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!--Fin Modal acepar-->
                                    <!-- Modal -->
                                    <div class="modal fade" :id="'RechazarModal_'+especia.id"  tabindex="-1" :aria-labelledby="'RechazarModalLabel_'+especia.id" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                Seguro que desea rechazar la solicitud de <b>{{especia.usuario.name}}</b>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                <button type="button" class="btn btn-success" @click="rechazar(especia.id);" data-bs-dismiss="modal">Si, rechazar</button>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
